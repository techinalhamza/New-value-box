...
export default SingleProduct;
 ...
 const card = document.createElement("div");
              ...
              card.setAttribute("data-designer-id", designer.id);

              const img = document.createElement("img");
              img.src = designer.imgSrc;
              img.alt = ;

              const info = document.createElement("div");
              info.classList.add("designer-card-info");

              const name = document.createElement("h3");
              name.textContent = designer.name;

              const desc = document.createElement("p");
              desc.classList.add("designer-card-desc");
              desc.textContent = truncateText(designer.description, 140);
              ...
              contactBtn.textContent = "Contact Designer";
